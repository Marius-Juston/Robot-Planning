...
class TrapezoidalCurve(MotionProfile):
    def find_accelerating_constants(self, v_initial, v_final, acceleration_max):
        delta_v = v_final - v_initial

        if delta_v == 0:
            return 0, 0, v_initial, 0
        ...
        return t, d, v_initial, a

    def find_flat_constants(self, s_initial, s_final, d_a, d_b, v_max):
        delta_d = s_final - s_initial - d_a - d_b
        t = delta_d / v_max

        return t, delta_d, v_max, 0
